...
Exercised in-process by monkeypatching the user store; the actual
...
def test_background_user_ids_excludes_disabled(monkeypatch, tmp_path):
    ...
    assert set(main._background_user_ids()) == {a, b}  # carol excluded
