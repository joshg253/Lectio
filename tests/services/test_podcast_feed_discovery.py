...
@pytest.mark.parametrize(
    "html,expected",
    [
        ('<a href="https://feeds.libsyn.com/21070/rss">rss</a>', "https://feeds.libsyn.com/21070/rss"),
        ("player: https://feeds.buzzsprout.com/1501960.rss ", "https://feeds.buzzsprout.com/1501960.rss"),
        ('<link href="https://feeds.transistor.fm/my-show" />', "https://feeds.transistor.fm/my-show"),
        ("x https://feeds.megaphone.fm/ABCD1234 y", "https://feeds.megaphone.fm/ABCD1234"),
        ('<a href="https://feeds.simplecast.com/abc123">', "https://feeds.simplecast.com/abc123"),
        ("https://anchor.fm/s/abc123/podcast/rss", "https://anchor.fm/s/abc123/podcast/rss"),
    ],
)
...
def test_earliest_occurrence_wins():
    ...
    html = "https://feeds.buzzsprout.com/111.rss and later https://feeds.libsyn.com/222/rss"
...
def _host_feed(*items: str) -> str:
    return '<?xml version="1.0"?><rss version="2.0"><channel><title>Host</title>' + "".join(items) + "</channel></rss>"
...
def test_match_ignores_punctuation_and_entities():
    ...
    feed = _host_feed(_host_item("Episode 291: autoresearch with Opus 4.8 & GPT 5.5", "https://cdn.test/291.mp3"))
...
def test_match_by_episode_number_when_titles_differ():
    ...
    out = pfd.match_episode_audio(feed, {"e": "SE Radio 725: Danny Yang and Sam Goldman on the Pyrefly Type Checker"})
