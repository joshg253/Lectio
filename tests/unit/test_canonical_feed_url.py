...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("https://old.reddit.com/r/boardgamedeals/.rss", "https://www.reddit.com/r/boardgamedeals/.rss"),
        # Leading/trailing whitespace is stripped before normalization.
        ("  https://old.reddit.com/r/x/.rss  ", "https://www.reddit.com/r/x/.rss"),
...
def test_a_selector_is_still_stripped_when_a_real_feed_path_remains():
    ...
    assert main.canonical_feed_url("https://example.com/feed?alt=rss") == "https://example.com/feed"
