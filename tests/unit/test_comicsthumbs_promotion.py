...
def test_uses_lead_image_when_filenames_match():
    ...
    out = main._promote_comicsthumbs_in_content(BODY, "https://www.atomic-robo.com/comics/1782426355-ARV1701_05.jpg")
...
def test_does_not_substitute_a_different_comic():
    ...
    out = main._promote_comicsthumbs_in_content(BODY, "https://www.atomic-robo.com/comics/12345-SOMETHING_ELSE.jpg")
    assert out == BODY
    assert "SOMETHING_ELSE" not in out


def test_stable_name_strips_timestamp_prefix():
    assert main._comiccontrol_stable_name("https://x/comics/1782426355-ARV1701_05.jpg") == "ARV1701_05.jpg"
